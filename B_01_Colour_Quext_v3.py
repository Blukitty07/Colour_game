...
def get_colours():
    ...
    :return: list fo colours which where each list item has the
     colour name, associated score and foreground colours for the text
    """
...
class StartGame:
    ...
    def __init__(self):
        ...
        # List of labels tobe made (text | font | fg)
        start_labels_list = [
        ...
        for count, item in enumerate(start_labels_list):
            make_label = Label(self.start_frame, text=item[0], font=item[1],
                               fg=item[2],
                               wraplength=350, justify="left", padx=10, pady=20)
            make_label.grid(row=count)

            start_label_ref.append(make_label)

        # extract choice label so that it can be changed
        # to an error message if necessary
    ...
    def check_rounds(self):
        ...
        try:
            ...
            if rounds_wanted > 0:
                # Clear entry box and reset instructions label so that when
                # users play a new game, they don't see and error message
        ...
        if has_errors == "yes":
            self.choose_label.config(text=error, fg="#009900", font=("Arial", "10", "bold"))
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        play_labels_list = [
            ["Round # o f #", ("Arial", "16", "bold"), None, 0],
        ...
        # create four buttons in a 2x2 grid
        ...
        self.eng_game_button = control_ref_list[3]
    ...
    def new_round(self):
        """
        Choose four colours, works out media for score to beat.
        ...
        self.heading_label.config(text=f"Round {rounds_played + 1} or {rounds_wanted}")
    ...
    def round_results(self, user_choice):
        ...
        if rounds_played == rounds_wanted:
            ...
            self.choose_label.config(text="Please press the Stats button for more info")
            
            self.next_button.config(state=DISABLED, text="Game Over")
            self.stats_button.config(bg="#990000")
            self.eng_game_button.config(text="Play Again", bg="#006600")
